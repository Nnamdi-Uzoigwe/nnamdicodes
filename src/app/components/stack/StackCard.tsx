...
const StackCard = ({image, name, brief, alt}: stackCardProps) => {
  return (
    <div className="bg-[#f6f6f6] dark:bg-[#181818] border px-8 pb-4 border-gray-200 rounded-[20px] flex flex-col justify-end gap-10 h-auto min-h-[300px] dark:border-[#383737]">
