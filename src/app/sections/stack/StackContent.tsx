...
const StackContent = () => {
  ...
  return (
    <div className="border-t border-gray-200 dark:border-gray-800 py-10 px-6 lg:px-60">
      <h4 className="text-[#808080] text-2xl font-bold">Dev & Design</h4>

      <div className="pt-8 pb-20 grid grid-cols-1 lg:grid-cols-3 gap-4">
        {stackData.map((item) => (
          <StackCard
            key={item.id}
            name={item.name}
